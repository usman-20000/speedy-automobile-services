...
export default function Header() {
  ...
  return (
    <header className="w-full backdrop-blur-sm bg-white/70 dark:bg-gray-900/60 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden lg:flex items-center gap-3 ml-2">
            ...
            <button onClick={handleWhatsAppClick} className="inline-flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg shadow-lg hover:opacity-95">
              WhatsApp
            </button>
          </div>
